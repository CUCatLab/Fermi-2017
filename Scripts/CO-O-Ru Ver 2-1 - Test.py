...
class Run :
    ...
    def Parameters(self,Region) :
        ...
        dic = {
            ...
            'Runs': 'XAS_000_000',
            'BackgroundRun': 'XAS_017_017_bin.h5',
    #         'BackgroundRun': 'None',
            'NormROI': (285, 286.4),
            'xOffset': -0.31,
            'Normalize': False,
        ...
        if Region == 'Pi Star' :
            ...
            dic['Zones'] = {
                            ...
                            # 'Negative': {'Range': (288.5,289), 'a': -0.0014, 'b': 0.008, 't0': 370, 'sigma': 650},
                            # 'Vibrational': {'Range': (287.1,287.4), 'a': 0.011, 'b': 0, 't0': 340, 'sigma': 710},
                            # 'Delta v < 0': {'Range': (286.7,287.1), 'a': 0.004, 'b': 0, 't0': 150, 'sigma': 740},
                            # 'Transition state': {'Range': (287.5,287.8), 'a': 0.044, 'b': 0, 't0': 780, 'sigma': 1200}
                           }
    ...
    def FitData(self,Energy,Delay,Signal,ErrorBars,Region,NumberPeaks,NumRefPeaks) :
        ...
        while i < len(Delay) :
            ...
            if Region == 'Pi Star' :
                ...
                Params['L1_intercept'].value = -0.003396881
                Params['L1_intercept'].vary = True
                Params['L1_slope'].value = 1.19E-05
                ...
                if NumberPeaks >= 2 :
                    ...
                    Params[Name+'_center'].value = 287.34
                    Params[Name+'_center'].vary = False
                    Params[Name+'_sigma'].value = 0.11
                ...
                if NumberPeaks >= 3 :
                    ...
                    Params[Name+'_amplitude'].min = 0
                    Params[Name+'_amplitude'].vary = True
                    Params[Name+'_center'].set(expr='G4_center+0.256')
                    Params[Name+'_sigma'].value = 0.11
                    Params[Name+'_sigma'].min = 0.1
                    Params[Name+'_sigma'].vary = False
                if NumberPeaks >= 4 :
                    ...
                    Params[Name+'_amplitude'].min = 0
                    Params[Name+'_amplitude'].vary = True
                    Params[Name+'_center'].value = 287.05
                    # Params[Name+'_center'].max = 287.02
                    Params[Name+'_center'].vary = False
                    Params[Name+'_sigma'].value = .17
                    Params[Name+'_sigma'].min = .1
                    # Params[Name+'_sigma'].max = .3
                    Params[Name+'_sigma'].vary = False
    #             if NumberPeaks >= 2 :
