...
def FitData(Energy,Delay,Signal,ErrorBars,Region,NumberPeaks,NumRefPeaks) :
    ...
    while i < len(Delay) :
        ...
        if Region == 'Pi Star' :
            ...
            Params['L1_slope'].value = -0.000
            Params['L1_slope'].max-0.0005
            Params['L1_slope'].vary = True
            Params['L1_intercept'].value = 0.1
            Params['L1_intercept'].max = 0.16
            Params['L1_intercept'].vary = True
            Params['G1_amplitude'].value = 0.02
            Params['G1_amplitude'].min = 0
#             Params['G1_center'].value = 288.01
            Params['G1_center'].value = 288.08
